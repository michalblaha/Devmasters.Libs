...
namespace Devmasters.AutoUpdateLauncher.Helpers
{
    ...
    public class LogMessage : Dictionary<string, object>
    {
        ...
        public static string AllVersions(string[] allowedNamespaces )
        {
            ...
            if (cache[CACHE_AllAssemblyVersions] == null)
            {
                string ver = "";
                ...
                cache.Add(CACHE_AllAssemblyVersions, ver, null, DateTime.UtcNow.AddDays(2), TimeSpan.Zero, System.Web.Caching.CacheItemPriority.NotRemovable, null);
            }
            return cache[CACHE_AllAssemblyVersions].ToString();
        }
