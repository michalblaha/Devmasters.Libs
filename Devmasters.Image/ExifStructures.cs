...
namespace Devmasters.Imaging {
    ...
    public enum ExifTagName : int {
        ...
        XPKeywords = 0x9c9e,
        XPSubject = 0x9c9f,
        X_DevmastersRating = 0xFA01   // Custom tag for rating 0-5
    }
    ...
    public enum ExifOrientation {
        ...
        RightBottom = 7,
        LeftBottom = 8,
        NeedsRotation = LeftTop | RightTop | RightBottom | LeftBottom
    }
    ...
    public enum ExifExposureMeteringMode {
        Unknown = 0,
        Average = 1,
    ...
    public enum ExifDataType : short {
        ByteArray = 1,
        String = 2,
        UnsignedShort = 3,
        UnsignedLong = 4,
    ...
    public struct ExifRational {
		...
		public int ToInt32()
		{
			return Convert.ToInt32(this.ToDouble());
		}
