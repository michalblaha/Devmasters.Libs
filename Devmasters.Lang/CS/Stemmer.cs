...
namespace Devmasters.Lang
{
    public class Stemmer
    {
        ...
        private WordList hunspell = null;
        private Stemmer(string lang)
        {
            WordList dictionary = WordList.CreateFromFiles(@"English (British).dic");

            string dotnetLang = lang.Replace("_", "-");
            hunspell = WordList.CreateFromFiles(rootDir + "\\" + lang + ".dic", rootDir + "\\" + lang + ".aff");
